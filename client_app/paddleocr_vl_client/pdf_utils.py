...
def render_pdf_to_images(pdf_path: Path, out_dir: Path, dpi: int = 300) -> List[RenderedPage]:
    """
    ...
    try:
        ...
        raise RuntimeError("未安装 PyMuPDF，无法处理 PDF。请安装：pip install PyMuPDF") from e
